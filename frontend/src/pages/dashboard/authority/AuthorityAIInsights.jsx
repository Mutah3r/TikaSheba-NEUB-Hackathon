...
import { askAuthorityChat } from "../../../services/aiService";
...
const AuthorityAIInsights = () => {
  ...
  const onSend = async () => {
    ...
    setResponse("");
    try {
      const res = await askAuthorityChat(prompt);
      const text =
        typeof res === "string"
          ? res
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-xl font-semibold text-[#081F2E]">
          AI Insights for Authority Operations
        </h2>
      </div>
      ...
      <div className="rounded-2xl bg-white/70 backdrop-blur-md shadow-sm ring-1 ring-[#081F2E]/10 p-6">
        <div className="text-sm text-[#0c2b40]/80 mb-4">
          Ask operations-related questions or tap a suggested prompt below. The
          AI response will appear above the text box.
        </div>
